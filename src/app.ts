  ...
  const element: HTMLElement | null = document.getElementById('main-container');
  if (element) {
    // Use element here
...
// Type assertion for the buttons
const btn1 = document.querySelector(".box:nth-of-type(1)") as HTMLElement
const btn2 = document.querySelector(".box:nth-of-type(2)") as HTMLElement
const btn3 = document.querySelector(".box:nth-of-type(3)") as HTMLElement
const btn4 = document.querySelector(".box:nth-of-type(4)") as HTMLElement
const btn5 = document.querySelector(".box:nth-of-type(5)") as HTMLElement
